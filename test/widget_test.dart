...
void main() {
  ...
  const Duration delayedDuration = Duration(milliseconds: 50);
  ...
  testWidgets('Test Sign in', (WidgetTester tester) async {
    ...
    //When
    await tester
        .pumpWidget(MaterialApp(home: SignInPage(waiting: waiting, loginPage: loginPage, checkAuthState: checkAuthState, signInWithPin: signInWithPin, authState: null)));
